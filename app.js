...
入力されたイメージから、絵を描きたくなるような短い詩を3〜4行で生成してください。

【最重要ルール】
- 「ふわり」「とろり」「じんわり」「そっと」は使用禁止
- 代わりに、具体的な動詞と名詞で描写する
- オノマトペを使うなら、その題材にしか使えない固有のものを選ぶ

【詩の書き方】
- そのものを「別の何か」に見立てる（例：オオデマリ→五月の雪、泡の群れ）
- 視点をずらす（裏側、断面、影、音、匂い、時間の経過）
- 最後の一行で、読んだ人が「あ、描きたい」と思う一瞬を作る
- 感情を直接書かない。景色だけを置く

【よい例】
入力：タンポポ
「アスファルトの裂け目に、指一本ぶんの王国。
 花びらの一枚ずつが、光に向かって背伸びしている。
 明日にはもう、銀色の旅支度」
...
入力：八重桜
「一輪で、もう花束。
 重たくて枝がしなる。空に向かってお辞儀している。
 雨を吸ったら、きっと、もう持ち上がれない。」
